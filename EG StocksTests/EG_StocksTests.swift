//
//  EG_StocksTests.swift
//  EG StocksTests
//
//  Created by Bekzat Kalybayev on 24.03.2022.
//

@testable import EG_Stocks

import XCTest

class EG_StocksTests: XCTestCase {
    
    func testSomething() {
        let number = 1
        let string = "1"
        
        XCTAssertEqual(number, Int(string), "Numbers don't match")
    }
